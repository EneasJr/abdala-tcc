...
public class Login extends javax.swing.JFrame {
    ...
    private boolean validateLogin() {
        char[] ps = this.txtSenha.getPassword();
        String lg = this.txtLogin.getText();
        lg = lg.trim();
        if (lg.length() == 0) {
            ...
            for (int i = 0; i < this.txtSenha.getPassword().length; i++) {
                sb.append(this.txtSenha.getPassword()[i]);
            }
            String sSenha = sb.toString();
            Usuario usuario = controller.autenticaUsuario(this.txtLogin.getText(), sSenha);
            if (usuario != null) {
